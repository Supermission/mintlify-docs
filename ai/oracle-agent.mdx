...
<Frame>
  <video autoPlay muted loop playsInline style={{ width: '100%', borderRadius: '12px' }} src="/ai .mp4" />
</Frame>
...
## Tips for getting the most out of Oracle

- **Be specific with amounts.** "Buy $50 on YES" works better than "buy some."
- **Use market keywords.** You don't need the exact market title — Oracle searches by keyword.
- **Chain commands.** "Sell my BTC position and buy $100 on YES for the ETH market" works in one message.
- **Ask for context.** "Why is this market moving?" triggers Oracle to pull AI analysis and recent activity.
