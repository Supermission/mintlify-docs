...
| `sentiment` | `bullish` \| `bearish` | AI directional prediction |
| `favourite_outcome` | `YES` \| `NO` | Which side the AI recommends |
| `ai_summary` | string | Brief explanation of the signal |
| `source_article_urls` | string[] | Links to evidence sources |
| `tags` | string[] | Signal tags (e.g., "Cricket", "NFL") |

Plus enriched market data: question, volume, 24h volume, liquidity, end date, categories.
