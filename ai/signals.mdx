...
<CardGroup cols={3}>
  ...
  <Card title="Momentum" icon="arrow-trend-up">
    Price action confirms what sentiment already predicted. The market is moving toward the AI's estimate. A trend-following signal.
  </Card>
...
You can filter the signal feed by:
