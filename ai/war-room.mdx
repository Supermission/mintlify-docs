---
title: "AI War Room"
description: "Four AI agents debate every market. Watch the reasoning, not just the number."
---
...
<CardGroup cols={2}>
  <Card title="Bull" icon="arrow-up">
    Finds every reason the market should be higher. Optimistic framing. Looks for catalysts, positive sentiment shifts, and underpriced probabilities.
  </Card>
...
## Reading the agent debate

Each agent card in the War Room shows the agent's individual probability estimate, key arguments, and supporting evidence. You can compare how each agent weighted different factors and where they disagree.

Pay special attention to the points of disagreement. When Bull says 85% and Bear says 40%, the reasoning behind each number is more valuable than the numbers themselves.
