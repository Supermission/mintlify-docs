...
<Info>
  For developers building agents: server-side wallets are also available with AES-256 encrypted private key storage and configurable spending policies. See [Agent Economy](/developers/agent-economy) for details.
</Info>
