...
- **GoPlus Security** — smart contract vulnerability scanning, holder concentration analysis
- **On-chain data** — Alchemy/Blockdaemon for balances, transfers, holder metrics
- **Price feeds** — CoinGecko, CoinDesk for current and historical pricing
- **AI analysis** — OpenRouter LLM for narrative generation and verdict
