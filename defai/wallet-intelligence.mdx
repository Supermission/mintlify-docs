...
|--------|--------------|
| **Alchemy** | Token balances, transfer history, NFT data |
| **Blockdaemon** | Multi-chain balance enrichment |
| **Nansen** | On-chain wallet intelligence and labels |
| **AI analysis** | Behavioral profiling and recommendations |
