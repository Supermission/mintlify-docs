...
| Sort | Description |
|------|-------------|
| **Volume** (default) | Highest lifetime trading volume first. Shows the most established, liquid markets. |
| **Trending** | Markets with the biggest recent volume spikes. Something just happened or is about to. |
| **Newest** | Most recently created markets first. Fresh opportunities that might not be fully priced yet. |
