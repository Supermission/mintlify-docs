...
<CardGroup cols={2}>
  ...
  <Card title="Bottom Navigation" icon="bars">
    Main sections — Markets, Portfolio, Watchlist, Agents — are accessible from a bottom nav bar. Thumb-friendly. Always visible.
  </Card>
...
The app is optimized for speed. Market data streams in real-time. Pages load fast, even on spotty connections.
...
<Warning>
  Price alerts require the app to be in the foreground or installed to your home screen. Background notifications aren't supported yet — if you need to catch a move, keep the tab open.
</Warning>
