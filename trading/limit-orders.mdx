...
A limit order says: "I'll buy at this price or better — and I'll wait." The order sits on the orderbook until someone takes the other side, or you cancel it.
...
<Steps>
  ...
  <Step title="Set your price">
    Enter your price in cents. YES shares at 45c means you think there's at least a 45% chance of this happening. Tick size is 1 cent.
  </Step>
  <Step title="Set your size">
    Enter USDC amount or share count. The panel calculates the other.
  </Step>
  <Step title="Submit">
    Click **Place Limit Order**. It stays on the orderbook until filled or you manually cancel.
  </Step>
</Steps>
...
<Info>
  The minimum tick size is **$0.01** (1 cent). You can place orders at any cent increment — $0.42, $0.73, whatever you like.
</Info>

## Limit vs. Instant: when to use what
...
<Tabs>
  ...
  <Tab title="Use Instant Orders When...">
...
<Tip>
  The best edges come from limit orders that other traders buy into. You provide liquidity, you capture the spread. That's the game.
</Tip>
