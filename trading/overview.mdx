...
<Steps>
  <Step title="Balance check">
    The system checks your USDC balance on Base. If insufficient, you'll see a warning.
  </Step>
  <Step title="Chain preparation">
    Your Privy embedded wallet switches to Polygon (where Polymarket's CLOB operates). Gas funding is handled automatically.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Portfolio" icon="chart-pie" href="/trading/portfolio">
    Three-tab view: active positions with P&L, open limit orders with cancel, and complete trade history with CSV export.
  </Card>
