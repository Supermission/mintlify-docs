...
<Steps>
  ...
  <Step title="Confirm">
    Click **Confirm Sell**. The order fills instantly against current orderbook liquidity.
  </Step>
</Steps>
...
Sale proceeds land in your wallet balance immediately. From there you can:
